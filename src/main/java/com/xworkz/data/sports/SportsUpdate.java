...
public class SportsUpdate {
    ...
    public static void main(String[] args) {
                ...
                try {
                    ...
                    System.out.println("Updating Sports Table Started...");


                    String sql = "update sports set players_count=11 where sport_id=1";
                    int row = statement.executeUpdate(sql);
                    System.out.println("row:" + row);

                    String sql1 = "update sports set players_count=11 where sport_id=2";
                    int row1 = statement.executeUpdate(sql1);
                    System.out.println("row:" + row1);

                    String sql2 = "update sports set players_count=11 where sport_id=3";
                    int row2 = statement.executeUpdate(sql2);
                    System.out.println("row:" + row2);

                    String sql3 = "update sports set players_count=11 where sport_id=4";
                    int row3 = statement.executeUpdate(sql3);
                    System.out.println("row:" + row3);

//                    =========================================================

                    String sql4 = "update sports set stadium='National Stadium' where sport_id=1";
                    int row4 = statement.executeUpdate(sql4);
                    System.out.println("row1:" + row4);

                    String sql5 = "update sports set stadium='National Stadium' where sport_id=2";
                    int row5 = statement.executeUpdate(sql5);
                    System.out.println("row1:" + row5);

                    String sql6 = "update sports set stadium='National Stadium' where sport_id=3";
                    int row6 = statement.executeUpdate(sql6);
                    System.out.println("row1:" + row6);

                    String sql7 = "update sports set stadium='National Stadium' where sport_id=4";
                    int row7 = statement.executeUpdate(sql7);
                    System.out.println("row1:" + row7);

//                    ==================================================

                    String sql8 = "update sports set origin_country='India' where sport_id=1";
                    int row8 = statement.executeUpdate(sql8);
                    System.out.println("row2:" + row8);

                    String sql9 = "update sports set origin_country='India' where sport_id=2";
                    int row9 = statement.executeUpdate(sql9);
                    System.out.println("row2:" + row9);

                    String sql10 = "update sports set origin_country='India' where sport_id=3";
                    int row10 = statement.executeUpdate(sql10);
                    System.out.println("row2:" + row10);

                    String sql11 = "update sports set origin_country='India' where sport_id=4";
                    int row11 = statement.executeUpdate(sql11);
                    System.out.println("row2:" + row11);

//                    =====================================================

                    String sql12 = "update sports set popularity_rank=1 where sport_id=1";
                    int row12 = statement.executeUpdate(sql12);
                    System.out.println("row3:" + row12);

                    String sql13 = "update sports set popularity_rank=1 where sport_id=2";
                    int row13 = statement.executeUpdate(sql13);
                    System.out.println("row3:" + row13);

                    String sql14 = "update sports set popularity_rank=1 where sport_id=3";
                    int row14 = statement.executeUpdate(sql14);
                    System.out.println("row3:" + row14);

                    String sql15 = "update sports set popularity_rank=1 where sport_id=4";
